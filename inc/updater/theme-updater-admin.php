...
class Themedd_Updater_Admin {
	...
	function license_page() {
		...
		<div class="wrap license-wrap">
			<h2 class="headline">主题激活</h2>
			<div class="themedd-license-management-wrap">
                <p>十分荣幸您能使用我们的“<?php echo WPSTORM_THEME_NAME ;?>”主题。</p>
                <p>为了能够及时方便的为您更新主题，请您移步至我们的<a href="https://www.wpmee.com/">官网</a>购买主题</p>
                <p>激活码会发到您的账户邮箱中</p>
                <p>如果您遇到什么问题可以加入我们的qq群讨论，群号：463190586</p>
                <p>同时也可以关注我们的公众号，会有优惠券免费主题等福利</p>
                <p style="margin-top: 2rem">
                    <img src="<?php bloginfo('template_url')?>/static/images/wpstorm.jpg" alt="关注微信公众号" style="width: 150px;">
                </p>
				...
				<form method="post" action="options.php">
					...
					<?php
						...
						submit_button( __( '更新激活码', 'themedd' ) );
					?>
				</form>
			</div>
		</div>
