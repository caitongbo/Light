...
$updater = new Themedd_Updater_Admin(
	...
	// Config settings
	$config = array(
		'remote_api_url' => 'https://www.wpmee.com/',
		'item_name'      => 'jenney',
		'theme_slug'     => 'jenney',
		'version'        => WPSTORM_THEME_VERSION,
		'author'         => WPSTORM_THEME_AUTHOR,
		'download_id'    => '1072', // Optional, used for generating a license renewal link
		'renew_url'      => '' // Optional, allows for a custom license renewal link
	),

	$strings = array(
		'theme-license'             => __( '主题激活', 'part of the WordPress dashboard Themedd menu title', 'themedd' ),
...
function wpstorm_license_notify() {
    $status = get_option( 'jenney_license_key_status' );
...
add_action( 'wp_head', 'wpstorm_license_notify' );
